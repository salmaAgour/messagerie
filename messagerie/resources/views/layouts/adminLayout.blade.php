...
<body dir="rtl">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="height:70px">
        <a class="navbar-brand"  href="{{ url('/admin/dashboard') }}">الرئيسية</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="{{ url('/admin/dashboard') }}"> لائحة الرسائل الصادرة </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('createA') }}">كتابة رسالة</a>
            </li>
            <li class="nav-item" style="margin-right: 1100px">
